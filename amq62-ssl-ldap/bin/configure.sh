...
LdapJmxConfiguration { \n\
    com.sun.security.auth.module.LdapLoginModule REQUIRED \n\
        ...
        authIdentity=\"uid={USERNAME},ou=User,ou=ActiveMQ,dc=activemq,dc=apache,dc=org\" \n\
        userFilter=\"(\&(objectClass=person)(uid={USERNAME})(memberOf=cn=admins,ou=Group,ou=ActiveMQ,dc=activemq,dc=apache,dc=org))\" \n\
        authzIdentity=\"admins_in_ldap\" \n\
        useSSL=false \n\
        debug=true \n\
        ;\n\
};"
